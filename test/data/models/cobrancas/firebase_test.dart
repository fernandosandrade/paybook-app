...
void main() async {
  ...
  group('description', () {
    // var book101home = AppRoutes.Books.book101URLTemplate;

    test('description', () async {
      var collectionPath =
          RepositoryCollectionPath.of(["cobrancas", "101", "111"]);
      var dbDocument = await DocumentRepository.onCollection(collectionPath)
          .findByID("JE4RTA1UbozO4r6fIkMU");
      print(dbDocument);
    });
  });
}
