...
class BookSimplesListPage extends AbstractBookList {
  ...
  BookSimplesListPage(Book101Model bookSimplesModel)
      : bookController = BookSimplesListController(
            cobrancaSimplesRepository: Cobranca111Service(firestore: Firestore.instance),
  ...
  Widget _appBarHeader() {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Obx(() =>
              Text('${bookController.totalCobrancas} cobranças', style: TextStyle(color: Colors.white, fontSize: 20))),
          SizedBox(height: 10),
