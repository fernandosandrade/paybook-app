...
class CardCobranca111 extends StatelessWidget {
  final Cobranca111Model cobrancaSimplesModel;

  CardCobranca111({required this.cobrancaSimplesModel});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () => Get.toNamed(AppRoutes.COBRANCA_SIMPLES_FORM + '?id_cobranca=' + cobrancaSimplesModel.id),
      ),
    );
  }
