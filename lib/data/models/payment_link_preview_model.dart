...
abstract class PaymentLinkPreviewModel implements Built<PaymentLinkPreviewModel, PaymentLinkPreviewModelBuilder> {
  PaymentLinkPreviewModel._();
  factory PaymentLinkPreviewModel([void Function(PaymentLinkPreviewModelBuilder) updates]) = _$PaymentLinkPreviewModel;
  ...
  Map<String, dynamic> toMap() {
    var serialized = serializers.serializeWith(PaymentLinkPreviewModel.serializer, this) as Map<String, dynamic>;
