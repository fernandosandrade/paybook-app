...
abstract class Book101Model extends Object implements BookBaseModel, Built<Book101Model, Book101ModelBuilder> {
  ...
  Map<String, dynamic> toMap() {
    var serialized = serializers.serializeWith(Book101Model.serializer, this) as Map<String, dynamic>;
